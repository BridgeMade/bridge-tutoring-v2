...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-full">
      ...
      {/* Hero */}
      <section className="bg-coral-400 text-white py-20 sm:py-28">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              <Link
                href="/request-tutor"
                className="inline-flex items-center justify-center rounded-xl bg-white text-coral-500 font-semibold px-8 py-4 text-base hover:bg-coral-50 transition-colors"
              >
                Find a tutor
              </Link>
              <Link
                href="/become-tutor"
                className="inline-flex items-center justify-center rounded-xl border-2 border-white/60 text-white font-semibold px-8 py-4 text-base hover:bg-white/10 transition-colors"
              >
                Become a tutor
              </Link>
            </div>
      ...
      {/* Trust bar */}
      <section className="bg-coral-500 text-white/90 py-4">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <ul className="flex flex-wrap items-center gap-x-8 gap-y-2 text-sm font-medium">
            <li className="flex items-center gap-2">
              <span className="text-white/60">✓</span> Human-matched, not algorithm-matched
            </li>
            <li className="flex items-center gap-2">
              <span className="text-white/60">✓</span> Pretoria &amp; Johannesburg
            </li>
            <li className="flex items-center gap-2">
              <span className="text-white/60">✓</span> Hear back within 24 hours
            </li>
            <li className="flex items-center gap-2">
              <span className="text-white/60">✓</span> In-person &amp; online
            </li>
          </ul>
        </div>
      </section>
